...
if __name__ == "__main__":
    ...
    while True:
        ...
        for motor in motors:
            ...
            t = time.time()
            pos = 1.0 * math.pi * math.sin(2.0 * math.pi * 0.1 * t)  # 0.1 Hz, amplitude 1.0 rad
            vel = 0.2 * math.pi * math.pi * math.cos(2.0 * math.pi * 0.1 * t)  # Target velocity is the derivative of position
